...
from langchain.agents import Tool, AgentType #create_csv_agent
    ...
    def _get_tools(self) -> list:
        ...
        for agent_document in self.documents:
            ...
            if agent_document.document.type == "CSV":
                print("No suported at this time")
                ...
                tools.append(
                    Tool.from_function(
                        ...
                        name="document-summarizre",
                        description="useful for smmarizing a whole document"
                    )
                )
